...
public:
  ...
  int CustomInit(const char * shaderBasePath, const char* vertexShader, const char* fragmentShader); // Init the program; "shaderBasePath" is the path to the folder containing the shaders.
